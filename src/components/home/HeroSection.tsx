          ...
          <div className="lg:col-span-7 flex flex-col space-y-5 sm:space-y-6">
            ...
            <div className="space-y-3.5 sm:space-y-4">
              <h1 className="font-heading font-[650] text-[clamp(1.7rem,5vw,4.2rem)] leading-[1.06] sm:leading-[1.02] tracking-[-0.04em] text-slate-950 max-w-2xl">
                <span className="block whitespace-nowrap sm:whitespace-normal">{t.hero.h1Line1}&nbsp;</span>
                <span className="block whitespace-nowrap sm:whitespace-normal">{t.hero.h1Line2}&nbsp;</span>
                <span className="block text-sky-800 font-[650]">{t.hero.h1Line3}</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              ...
              >
                <span className="relative z-10">{t.hero.ctaTrajectory}</span>
            ...
            <div className="pt-0.5">
              ...
              >
                ...
                <span>{t.hero.lattesCnpq}</span>
              </a>
            </div>

            {/* Barra de Síntese Rápida de Métricas */}
            <div className="pt-6 border-t border-slate-200/80 grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div>
                <p className="font-heading font-bold text-base sm:text-lg text-slate-950 tracking-[-0.035em]">{t.hero.statYears}</p>
                <p className="font-body font-normal text-[13px] text-slate-500 mt-0.5">{t.hero.statYearsSub}</p>
              </div>
              <div>
                <p className="font-heading font-semibold text-base sm:text-lg text-slate-950 tracking-[-0.025em]">{t.hero.statResearch}</p>
                <p className="font-body font-normal text-[13px] text-slate-500 mt-0.5">{t.hero.statResearchSub}</p>
              </div>
              <div>
                <p className="font-heading font-semibold text-base sm:text-lg text-slate-950 tracking-[-0.025em]">{t.hero.statFormation}</p>
                <p className="font-body font-normal text-[13px] text-slate-500 mt-0.5">{t.hero.statFormationSub}</p>
              </div>
              <div>
                <p className="font-heading font-semibold text-base sm:text-lg text-slate-950 tracking-[-0.025em]">{t.hero.statSolutions}</p>
                <p className="font-body font-normal text-[13px] text-slate-500 mt-0.5">{t.hero.statSolutionsSub}</p>
              </div>
            </div>
              ...
              <div className="relative bg-white/80 backdrop-blur-2xl p-3.5 rounded-[2.5rem] border border-white/95 shadow-[0_24px_70px_rgba(15,23,42,0.12)]">
                ...
                <div className="relative aspect-[3.4/4] w-full rounded-[2rem] overflow-hidden bg-slate-100 shadow-inner">
                  ...
                  <div className="absolute bottom-4 right-4 z-10 select-none pointer-events-none text-right">
                    <p className="font-script text-white text-2xl sm:text-3xl leading-none drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] -rotate-3">
                      {t.hero.script1}<br />
                      <span className="text-sky-200">{t.hero.script2}</span><br />
                      {t.hero.script3}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-2.5 px-3 py-1 flex items-center justify-between text-xs text-slate-600 font-body font-medium">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11.5px] text-slate-700 font-semibold">{t.hero.scientificBadge}</span>
                  </div>
                  <a
                    href="http://lattes.cnpq.br/7844785807954101"
                    target="_blank"
                  ...
                  >
                    <span>{t.hero.cnpqLattesOfficial}</span>
